...
public class Marcar implements Jogadas {
	...
	public Marcar(int i, int j, JanelaJogo window) {
		jogar(i, j, window);
	...
	private void verificarVitoria(Mapa mapa, JanelaJogo window) {
		int referencia = 0;
		int area = 0;
		...
		if (referencia == mapa.getNMinas()
			...
			JOptionPane.showMessageDialog(null,
					"Parabéns Você Ganhou!      Time: " + window.getContador() / 60 + ":" + window.getContador() % 60);
		}
	}
